...
class GovernorateCitiesSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $governorates = [
            ...
            ["id"=>"1","name_ar"=>"القاهرة","name_en"=>"Cairo", "cost" => rand(50, 150) . ".00"],
            ["id"=>"2","name_ar"=>"الجيزة","name_en"=>"Giza", "cost" => rand(50, 150) . ".00"],
            ["id"=>"3","name_ar"=>"الأسكندرية","name_en"=>"Alexandria", "cost" => rand(50, 150) . ".00"],
            ["id"=>"4","name_ar"=>"الدقهلية","name_en"=>"Dakahlia", "cost" => rand(50, 150) . ".00"],
            ["id"=>"5","name_ar"=>"البحر الأحمر","name_en"=>"Red Sea", "cost" => rand(50, 150) . ".00"],
            ["id"=>"6","name_ar"=>"البحيرة","name_en"=>"Beheira", "cost" => rand(50, 150) . ".00"],
            ["id"=>"7","name_ar"=>"الفيوم","name_en"=>"Fayoum", "cost" => rand(50, 150) . ".00"],
            ["id"=>"8","name_ar"=>"الغربية","name_en"=>"Gharbiya", "cost" => rand(50, 150) . ".00"],
            ["id"=>"9","name_ar"=>"الإسماعلية","name_en"=>"Ismailia", "cost" => rand(50, 150) . ".00"],
            ["id"=>"10","name_ar"=>"المنوفية","name_en"=>"Menofia", "cost" => rand(50, 150) . ".00"],
            ["id"=>"11","name_ar"=>"المنيا","name_en"=>"Minya", "cost" => rand(50, 150) . ".00"],
            ["id"=>"12","name_ar"=>"القليوبية","name_en"=>"Qaliubiya", "cost" => rand(50, 150) . ".00"],
            ["id"=>"13","name_ar"=>"الوادي الجديد","name_en"=>"New Valley", "cost" => rand(50, 150) . ".00"],
            ["id"=>"14","name_ar"=>"السويس","name_en"=>"Suez", "cost" => rand(50, 150) . ".00"],
            ["id"=>"15","name_ar"=>"اسوان","name_en"=>"Aswan", "cost" => rand(50, 150) . ".00"],
            ["id"=>"16","name_ar"=>"اسيوط","name_en"=>"Assiut", "cost" => rand(50, 150) . ".00"],
            ["id"=>"17","name_ar"=>"بني سويف","name_en"=>"Beni Suef", "cost" => rand(50, 150) . ".00"],
            ["id"=>"18","name_ar"=>"بورسعيد","name_en"=>"Port Said", "cost" => rand(50, 150) . ".00"],
            ["id"=>"19","name_ar"=>"دمياط","name_en"=>"Damietta", "cost" => rand(50, 150) . ".00"],
            ["id"=>"20","name_ar"=>"الشرقية","name_en"=>"Sharkia", "cost" => rand(50, 150) . ".00"],
            ["id"=>"21","name_ar"=>"جنوب سيناء","name_en"=>"South Sinai", "cost" => rand(50, 150) . ".00"],
            ["id"=>"22","name_ar"=>"كفر الشيخ","name_en"=>"Kafr Al sheikh", "cost" => rand(50, 150) . ".00"],
            ["id"=>"23","name_ar"=>"مطروح","name_en"=>"Matrouh", "cost" => rand(50, 150) . ".00"],
            ["id"=>"24","name_ar"=>"الأقصر","name_en"=>"Luxor", "cost" => rand(50, 150) . ".00"],
            ["id"=>"25","name_ar"=>"قنا","name_en"=>"Qena", "cost" => rand(50, 150) . ".00"],
            ["id"=>"26","name_ar"=>"شمال سيناء","name_en"=>"North Sinai", "cost" => rand(50, 150) . ".00"],
            ["id"=>"27","name_ar"=>"سوهاج","name_en"=>"Sohag", "cost" => rand(50, 150) . ".00"],
        ];
        $cities = [
            ["id" => "1","governorate_id" => "1","name_ar" => "15 مايو","name_en" => "15 May"],
            ["id" => "2","governorate_id" => "1","name_ar" => "الازبكية","name_en" => "Al Azbakeyah"],
            ...
            ["id" => "7","governorate_id" => "1","name_ar" => "الدرب الاحمر","name_en" => "Aldarb Alahmar"],
            ["id" => "8","governorate_id" => "1","name_ar" => "الزاوية الحمراء","name_en" => "Zawya al-Hamra"],
            ...
            ["id" => "12","governorate_id" => "1","name_ar" => "السيدة زينب","name_en" => "Sayeda Zeinab"],
            ["id" => "13","governorate_id" => "1","name_ar" => "الشرابية","name_en" => "El Sharabeya"],
            ["id" => "14","governorate_id" => "1","name_ar" => "مدينة الشروق","name_en" => "Shorouk"],
            ["id" => "15","governorate_id" => "1","name_ar" => "الظاهر","name_en" => "El Daher"],
            ["id" => "16","governorate_id" => "1","name_ar" => "العتبة","name_en" => "Ataba"],
            ["id" => "17","governorate_id" => "1","name_ar" => "القاهرة الجديدة","name_en" => "New Cairo"],
            ["id" => "18","governorate_id" => "1","name_ar" => "المرج","name_en" => "El Marg"],
            ["id" => "19","governorate_id" => "1","name_ar" => "عزبة النخل","name_en" => "Ezbet el Nakhl"],
            ...
            ["id" => "28","governorate_id" => "1","name_ar" => "باب الشعرية","name_en" => "Bab al-Shereia"],
            ["id" => "29","governorate_id" => "1","name_ar" => "بولاق","name_en" => "Bolaq"],
            ["id" => "30","governorate_id" => "1","name_ar" => "جاردن سيتى","name_en" => "Garden City"],
            ["id" => "31","governorate_id" => "1","name_ar" => "حدائق القبة","name_en" => "Hadayek El-Kobba"],
            ["id" => "32","governorate_id" => "1","name_ar" => "حلوان","name_en" => "Helwan"],
            ["id" => "33","governorate_id" => "1","name_ar" => "دار السلام","name_en" => "Dar Al Salam"],
            ...
            ["id" => "40","governorate_id" => "1","name_ar" => "مصر الجديدة","name_en" => "New Heliopolis"],
            ["id" => "41","governorate_id" => "1","name_ar" => "مصر القديمة","name_en" => "Masr Al Qadima"],
            ["id" => "42","governorate_id" => "1","name_ar" => "منشية ناصر","name_en" => "Mansheya Nasir"],
            ["id" => "43","governorate_id" => "1","name_ar" => "مدينة بدر","name_en" => "Badr City"],
            ["id" => "44","governorate_id" => "1","name_ar" => "مدينة العبور","name_en" => "Obour City"],
            ["id" => "45","governorate_id" => "1","name_ar" => "وسط البلد","name_en" => "Cairo Downtown"],
            ["id" => "46","governorate_id" => "1","name_ar" => "الزمالك","name_en" => "Zamalek"],
            ["id" => "47","governorate_id" => "1","name_ar" => "قصر النيل","name_en" => "Kasr El Nile"],
            ...
            ["id" => "51","governorate_id" => "1","name_ar" => "روض الفرج","name_en" => "Rod Alfarag"],
            ["id" => "52","governorate_id" => "1","name_ar" => "شيراتون","name_en" => "Sheraton"],
            ["id" => "53","governorate_id" => "1","name_ar" => "الجمالية","name_en" => "El-Gamaleya"],
            ["id" => "54","governorate_id" => "1","name_ar" => "العاشر من رمضان","name_en" => "10th of Ramadan City"],
            ["id" => "55","governorate_id" => "1","name_ar" => "الحلمية","name_en" => "Helmeyat Alzaytoun"],
            ["id" => "56","governorate_id" => "1","name_ar" => "النزهة الجديدة","name_en" => "New Nozha"],
            ["id" => "57","governorate_id" => "1","name_ar" => "العاصمة الإدارية","name_en" => "Capital New"],
            ["id" => "58","governorate_id" => "2","name_ar" => "الجيزة","name_en" => "Giza"],
            ["id" => "59","governorate_id" => "2","name_ar" => "السادس من أكتوبر","name_en" => "Sixth of October"],
            ["id" => "60","governorate_id" => "2","name_ar" => "الشيخ زايد","name_en" => "Cheikh Zayed"],
            ["id" => "61","governorate_id" => "2","name_ar" => "الحوامدية","name_en" => "Hawamdiyah"],
            ["id" => "62","governorate_id" => "2","name_ar" => "البدرشين","name_en" => "Al Badrasheen"],
            ...
            ["id" => "67","governorate_id" => "2","name_ar" => "منشأة القناطر","name_en" => "ManshiyetAl Qanater"],
            ...
            ["id" => "71","governorate_id" => "2","name_ar" => "كفر غطاطي","name_en" => "Kafr Ghati"],
            ["id" => "72","governorate_id" => "2","name_ar" => "منشأة البكاري","name_en" => "Manshiyet Al Bakari"],
            ...
            ["id" => "78","governorate_id" => "2","name_ar" => "بولاق الدكرور","name_en" => "Boulaq Dakrour"],
            ["id" => "79","governorate_id" => "2","name_ar" => "الواحات البحرية","name_en" => "Al Wahat Al Baharia"],
            ["id" => "80","governorate_id" => "2","name_ar" => "العمرانية","name_en" => "Omraneya"],
            ["id" => "81","governorate_id" => "2","name_ar" => "المنيب","name_en" => "Moneeb"],
            ["id" => "82","governorate_id" => "2","name_ar" => "بين السرايات","name_en" => "Bin Alsarayat"],
            ["id" => "83","governorate_id" => "2","name_ar" => "الكيت كات","name_en" => "Kit Kat"],
            ["id" => "84","governorate_id" => "2","name_ar" => "المهندسين","name_en" => "Mohandessin"],
            ["id" => "85","governorate_id" => "2","name_ar" => "فيصل","name_en" => "Faisal"],
            ["id" => "86","governorate_id" => "2","name_ar" => "أبو رواش","name_en" => "Abu Rawash"],
            ["id" => "87","governorate_id" => "2","name_ar" => "حدائق الأهرام","name_en" => "Hadayek Alahram"],
            ["id" => "88","governorate_id" => "2","name_ar" => "الحرانية","name_en" => "Haraneya"],
            ["id" => "89","governorate_id" => "2","name_ar" => "حدائق اكتوبر","name_en" => "Hadayek October"],
            ["id" => "90","governorate_id" => "2","name_ar" => "صفط اللبن","name_en" => "Saft Allaban"],
            ["id" => "91","governorate_id" => "2","name_ar" => "القرية الذكية","name_en" => "Smart Village"],
            ["id" => "92","governorate_id" => "2","name_ar" => "ارض اللواء","name_en" => "Ard Ellwaa"],
            ["id" => "93","governorate_id" => "3","name_ar" => "ابو قير","name_en" => "Abu Qir"],
            ["id" => "94","governorate_id" => "3","name_ar" => "الابراهيمية","name_en" => "Al Ibrahimeyah"],
            ...
            ["id" => "101","governorate_id" => "3","name_ar" => "المفروزة","name_en" => "Al Mafrouza"],
            ...
            ["id" => "107","governorate_id" => "3","name_ar" => "برج العرب","name_en" => "Bourj Alarab"],
            ["id" => "108","governorate_id" => "3","name_ar" => "ستانلى","name_en" => "Stanley"],
            ["id" => "109","governorate_id" => "3","name_ar" => "سموحة","name_en" => "Smouha"],
            ["id" => "110","governorate_id" => "3","name_ar" => "سيدى بشر","name_en" => "Sidi Bishr"],
            ["id" => "111","governorate_id" => "3","name_ar" => "شدس","name_en" => "Shads"],
            ["id" => "112","governorate_id" => "3","name_ar" => "غيط العنب","name_en" => "Gheet Alenab"],
            ["id" => "113","governorate_id" => "3","name_ar" => "فلمينج","name_en" => "Fleming"],
            ["id" => "114","governorate_id" => "3","name_ar" => "فيكتوريا","name_en" => "Victoria"],
            ["id" => "115","governorate_id" => "3","name_ar" => "كامب شيزار","name_en" => "Camp Shizar"],
            ["id" => "116","governorate_id" => "3","name_ar" => "كرموز","name_en" => "Karmooz"],
            ["id" => "117","governorate_id" => "3","name_ar" => "محطة الرمل","name_en" => "Mahta Alraml"],
            ["id" => "118","governorate_id" => "3","name_ar" => "مينا البصل","name_en" => "Mina El-Basal"],
            ...
            ["id" => "123","governorate_id" => "3","name_ar" => "كليوباترا","name_en" => "Cleopatra"],
            ["id" => "124","governorate_id" => "3","name_ar" => "جليم","name_en" => "Glim"],
            ["id" => "125","governorate_id" => "3","name_ar" => "المعمورة","name_en" => "Al Mamurah"],
            ["id" => "126","governorate_id" => "3","name_ar" => "المندرة","name_en" => "Al Mandara"],
            ["id" => "127","governorate_id" => "3","name_ar" => "محرم بك","name_en" => "Moharam Bek"],
            ["id" => "128","governorate_id" => "3","name_ar" => "الشاطبي","name_en" => "Elshatby"],
            ["id" => "129","governorate_id" => "3","name_ar" => "سيدي جابر","name_en" => "Sidi Gaber"],
            ["id" => "130","governorate_id" => "3","name_ar" => "الساحل الشمالي","name_en" => "North Coast\/sahel"],
            ["id" => "131","governorate_id" => "3","name_ar" => "الحضرة","name_en" => "Alhadra"],
            ["id" => "132","governorate_id" => "3","name_ar" => "العطارين","name_en" => "Alattarin"],
            ["id" => "133","governorate_id" => "3","name_ar" => "سيدي كرير","name_en" => "Sidi Kerir"],
            ...
            ["id" => "142","governorate_id" => "4","name_ar" => "منية النصر","name_en" => "Menia El Nasr"],
            ["id" => "143","governorate_id" => "4","name_ar" => "السنبلاوين","name_en" => "Sinbillawin"],
            ["id" => "144","governorate_id" => "4","name_ar" => "الكردي","name_en" => "El Kurdi"],
            ["id" => "145","governorate_id" => "4","name_ar" => "بني عبيد","name_en" => "Bani Ubaid"],
            ["id" => "146","governorate_id" => "4","name_ar" => "المنزلة","name_en" => "Al Manzala"],
            ["id" => "147","governorate_id" => "4","name_ar" => "تمي الأمديد","name_en" => "tami al'amdid"],
            ...
            ["id" => "165","governorate_id" => "6","name_ar" => "كفر الدوار","name_en" => "Kafr El Dawar"],
            ["id" => "166","governorate_id" => "6","name_ar" => "رشيد","name_en" => "Rashid"],
            ["id" => "167","governorate_id" => "6","name_ar" => "إدكو","name_en" => "Edco"],
            ["id" => "168","governorate_id" => "6","name_ar" => "أبو المطامير","name_en" => "Abu al-Matamir"],
            ["id" => "169","governorate_id" => "6","name_ar" => "أبو حمص","name_en" => "Abu Homs"],
            ["id" => "170","governorate_id" => "6","name_ar" => "الدلنجات","name_en" => "Delengat"],
            ["id" => "171","governorate_id" => "6","name_ar" => "المحمودية","name_en" => "Mahmoudiyah"],
            ["id" => "172","governorate_id" => "6","name_ar" => "الرحمانية","name_en" => "Rahmaniyah"],
            ["id" => "173","governorate_id" => "6","name_ar" => "إيتاي البارود","name_en" => "Itai Baroud"],
            ["id" => "174","governorate_id" => "6","name_ar" => "حوش عيسى","name_en" => "Housh Eissa"],
            ["id" => "175","governorate_id" => "6","name_ar" => "شبراخيت","name_en" => "Shubrakhit"],
            ["id" => "176","governorate_id" => "6","name_ar" => "كوم حمادة","name_en" => "Kom Hamada"],
            ["id" => "177","governorate_id" => "6","name_ar" => "بدر","name_en" => "Badr"],
            ["id" => "178","governorate_id" => "6","name_ar" => "وادي النطرون","name_en" => "Wadi Natrun"],
            ["id" => "179","governorate_id" => "6","name_ar" => "النوبارية الجديدة","name_en" => "New Nubaria"],
            ["id" => "180","governorate_id" => "6","name_ar" => "النوبارية","name_en" => "Alnoubareya"],
            ["id" => "181","governorate_id" => "7","name_ar" => "الفيوم","name_en" => "Fayoum"],
            ["id" => "182","governorate_id" => "7","name_ar" => "الفيوم الجديدة","name_en" => "Fayoum El Gedida"],
            ...
            ["id" => "187","governorate_id" => "7","name_ar" => "يوسف الصديق","name_en" => "Yusuf El Sediaq"],
            ...
            ["id" => "193","governorate_id" => "8","name_ar" => "المحلة الكبرى","name_en" => "Al Mahalla Al Kobra"],
            ["id" => "194","governorate_id" => "8","name_ar" => "كفر الزيات","name_en" => "Kafr El Zayat"],
            ...
            ["id" => "200","governorate_id" => "9","name_ar" => "الإسماعيلية","name_en" => "Ismailia"],
            ["id" => "201","governorate_id" => "9","name_ar" => "فايد","name_en" => "Fayed"],
            ["id" => "202","governorate_id" => "9","name_ar" => "القنطرة شرق","name_en" => "Qantara Sharq"],
            ["id" => "203","governorate_id" => "9","name_ar" => "القنطرة غرب","name_en" => "Qantara Gharb"],
            ["id" => "204","governorate_id" => "9","name_ar" => "التل الكبير","name_en" => "El Tal El Kabier"],
            ["id" => "205","governorate_id" => "9","name_ar" => "أبو صوير","name_en" => "Abu Sawir"],
            ["id" => "206","governorate_id" => "9","name_ar" => "القصاصين الجديدة","name_en" => "Kasasien El Gedida"],
            ["id" => "207","governorate_id" => "9","name_ar" => "نفيشة","name_en" => "Nefesha"],
            ["id" => "208","governorate_id" => "9","name_ar" => "الشيخ زايد","name_en" => "Sheikh Zayed"],
            ["id" => "209","governorate_id" => "10","name_ar" => "شبين الكوم","name_en" => "Shbeen El Koom"],
            ["id" => "210","governorate_id" => "10","name_ar" => "مدينة السادات","name_en" => "Sadat City"],
            ["id" => "211","governorate_id" => "10","name_ar" => "منوف","name_en" => "Menouf"],
            ["id" => "212","governorate_id" => "10","name_ar" => "سرس الليان","name_en" => "Sars El-Layan"],
            ...
            ["id" => "216","governorate_id" => "10","name_ar" => "بركة السبع","name_en" => "Berkat El Saba"],
            ["id" => "217","governorate_id" => "10","name_ar" => "تلا","name_en" => "Tala"],
            ["id" => "218","governorate_id" => "10","name_ar" => "الشهداء","name_en" => "Al Shohada"],
            ["id" => "219","governorate_id" => "11","name_ar" => "المنيا","name_en" => "Minya"],
            ["id" => "220","governorate_id" => "11","name_ar" => "المنيا الجديدة","name_en" => "Minya El Gedida"],
            ["id" => "221","governorate_id" => "11","name_ar" => "العدوة","name_en" => "El Adwa"],
            ["id" => "222","governorate_id" => "11","name_ar" => "مغاغة","name_en" => "Magagha"],
            ["id" => "223","governorate_id" => "11","name_ar" => "بني مزار","name_en" => "Bani Mazar"],
            ["id" => "224","governorate_id" => "11","name_ar" => "مطاي","name_en" => "Mattay"],
            ["id" => "225","governorate_id" => "11","name_ar" => "سمالوط","name_en" => "Samalut"],
            ["id" => "226","governorate_id" => "11","name_ar" => "المدينة الفكرية","name_en" => "Madinat El Fekria"],
            ["id" => "227","governorate_id" => "11","name_ar" => "ملوي","name_en" => "Meloy"],
            ["id" => "228","governorate_id" => "11","name_ar" => "دير مواس","name_en" => "Deir Mawas"],
            ["id" => "229","governorate_id" => "11","name_ar" => "ابو قرقاص","name_en" => "Abu Qurqas"],
            ["id" => "230","governorate_id" => "11","name_ar" => "ارض سلطان","name_en" => "Ard Sultan"],
            ["id" => "231","governorate_id" => "12","name_ar" => "بنها","name_en" => "Banha"],
            ["id" => "232","governorate_id" => "12","name_ar" => "قليوب","name_en" => "Qalyub"],
            ["id" => "233","governorate_id" => "12","name_ar" => "شبرا الخيمة","name_en" => "Shubra Al Khaimah"],
            ["id" => "234","governorate_id" => "12","name_ar" => "القناطر الخيرية","name_en" => "Al Qanater Charity"],
            ["id" => "235","governorate_id" => "12","name_ar" => "الخانكة","name_en" => "Khanka"],
            ["id" => "236","governorate_id" => "12","name_ar" => "كفر شكر","name_en" => "Kafr Shukr"],
            ...
            ["id" => "241","governorate_id" => "12","name_ar" => "شبين القناطر","name_en" => "Shibin Al Qanater"],
            ...
            ["id" => "252","governorate_id" => "14","name_ar" => "العين السخنة","name_en" => "Ain Sokhna"],
            ["id" => "253","governorate_id" => "14","name_ar" => "فيصل","name_en" => "Faysal"],
            ["id" => "254","governorate_id" => "15","name_ar" => "أسوان","name_en" => "Aswan"],
            ["id" => "255","governorate_id" => "15","name_ar" => "أسوان الجديدة","name_en" => "Aswan El Gedida"],
            ["id" => "256","governorate_id" => "15","name_ar" => "دراو","name_en" => "Drau"],
            ["id" => "257","governorate_id" => "15","name_ar" => "كوم أمبو","name_en" => "Kom Ombo"],
            ["id" => "258","governorate_id" => "15","name_ar" => "نصر النوبة","name_en" => "Nasr Al Nuba"],
            ["id" => "259","governorate_id" => "15","name_ar" => "كلابشة","name_en" => "Kalabsha"],
            ["id" => "260","governorate_id" => "15","name_ar" => "إدفو","name_en" => "Edfu"],
            ["id" => "261","governorate_id" => "15","name_ar" => "الرديسية","name_en" => "Al-Radisiyah"],
            ["id" => "262","governorate_id" => "15","name_ar" => "البصيلية","name_en" => "Al Basilia"],
            ["id" => "263","governorate_id" => "15","name_ar" => "السباعية","name_en" => "Al Sibaeia"],
            ["id" => "264","governorate_id" => "15","name_ar" => "ابوسمبل السياحية","name_en" => "Abo Simbl Al Siyahia"],
            ["id" => "265","governorate_id" => "15","name_ar" => "مرسى علم","name_en" => "Marsa Alam"],
            ["id" => "266","governorate_id" => "16","name_ar" => "أسيوط","name_en" => "Assiut"],
            ["id" => "267","governorate_id" => "16","name_ar" => "أسيوط الجديدة","name_en" => "Assiut El Gedida"],
            ...
            ["id" => "273","governorate_id" => "16","name_ar" => "الغنايم","name_en" => "El Ghanaim"],
            ["id" => "274","governorate_id" => "16","name_ar" => "ساحل سليم","name_en" => "Sahel Selim"],
            ["id" => "275","governorate_id" => "16","name_ar" => "البداري","name_en" => "El Badari"],
            ["id" => "276","governorate_id" => "16","name_ar" => "صدفا","name_en" => "Sidfa"],
            ["id" => "277","governorate_id" => "17","name_ar" => "بني سويف","name_en" => "Bani Sweif"],
            ["id" => "278","governorate_id" => "17","name_ar" => "بني سويف الجديدة","name_en" => "Beni Suef El Gedida"],
            ...
            ["id" => "285","governorate_id" => "17","name_ar" => "الاباصيرى","name_en" => "Alabbaseri"],
            ["id" => "286","governorate_id" => "17","name_ar" => "مقبل","name_en" => "Mokbel"],
            ["id" => "287","governorate_id" => "18","name_ar" => "بورسعيد","name_en" => "PorSaid"],
            ["id" => "288","governorate_id" => "18","name_ar" => "بورفؤاد","name_en" => "Port Fouad"],
            ...
            ["id" => "292","governorate_id" => "18","name_ar" => "حى الضواحى","name_en" => "Aldawahi"],
            ["id" => "293","governorate_id" => "18","name_ar" => "حى المناخ","name_en" => "Almanakh"],
            ["id" => "294","governorate_id" => "18","name_ar" => "حى مبارك","name_en" => "Mubarak"],
            ["id" => "295","governorate_id" => "19","name_ar" => "دمياط","name_en" => "Damietta"],
            ["id" => "296","governorate_id" => "19","name_ar" => "دمياط الجديدة","name_en" => "New Damietta"],
            ["id" => "297","governorate_id" => "19","name_ar" => "رأس البر","name_en" => "Ras El Bar"],
            ...
            ["id" => "302","governorate_id" => "19","name_ar" => "كفر البطيخ","name_en" => "Kafr El-Batikh"],
            ["id" => "303","governorate_id" => "19","name_ar" => "عزبة البرج","name_en" => "Azbet Al Burg"],
            ["id" => "304","governorate_id" => "19","name_ar" => "ميت أبو غالب","name_en" => "Meet Abou Ghalib"],
            ["id" => "305","governorate_id" => "19","name_ar" => "كفر سعد","name_en" => "Kafr Saad"],
            ["id" => "306","governorate_id" => "20","name_ar" => "الزقازيق","name_en" => "Zagazig"],
            ["id" => "307","governorate_id" => "20","name_ar" => "العاشر من رمضان","name_en" => "Al Ashr Men Ramadan"],
            ["id" => "308","governorate_id" => "20","name_ar" => "منيا القمح","name_en" => "Minya Al Qamh"],
            ["id" => "309","governorate_id" => "20","name_ar" => "بلبيس","name_en" => "Belbeis"],
            ["id" => "310","governorate_id" => "20","name_ar" => "مشتول السوق","name_en" => "Mashtoul El Souq"],
            ["id" => "311","governorate_id" => "20","name_ar" => "القنايات","name_en" => "Qenaiat"],
            ["id" => "312","governorate_id" => "20","name_ar" => "أبو حماد","name_en" => "Abu Hammad"],
            ["id" => "313","governorate_id" => "20","name_ar" => "القرين","name_en" => "El Qurain"],
            ["id" => "314","governorate_id" => "20","name_ar" => "ههيا","name_en" => "Hehia"],
            ["id" => "315","governorate_id" => "20","name_ar" => "أبو كبير","name_en" => "Abu Kabir"],
            ["id" => "316","governorate_id" => "20","name_ar" => "فاقوس","name_en" => "Faccus"],
            ["id" => "317","governorate_id" => "20","name_ar" => "الصالحية الجديدة","name_en" => "El Salihia El Gedida"],
            ["id" => "318","governorate_id" => "20","name_ar" => "الإبراهيمية","name_en" => "Al Ibrahimiyah"],
            ["id" => "319","governorate_id" => "20","name_ar" => "ديرب نجم","name_en" => "Deirb Negm"],
            ["id" => "320","governorate_id" => "20","name_ar" => "كفر صقر","name_en" => "Kafr Saqr"],
            ["id" => "321","governorate_id" => "20","name_ar" => "أولاد صقر","name_en" => "Awlad Saqr"],
            ["id" => "322","governorate_id" => "20","name_ar" => "الحسينية","name_en" => "Husseiniya"],
            ["id" => "323","governorate_id" => "20","name_ar" => "صان الحجر القبلية","name_en" => "san alhajar alqablia"],
            ["id" => "324","governorate_id" => "20","name_ar" => "منشأة أبو عمر","name_en" => "Manshayat Abu Omar"],
            ["id" => "325","governorate_id" => "21","name_ar" => "الطور","name_en" => "Al Toor"],
            ["id" => "326","governorate_id" => "21","name_ar" => "شرم الشيخ","name_en" => "Sharm El-Shaikh"],
            ...
            ["id" => "330","governorate_id" => "21","name_ar" => "سانت كاترين","name_en" => "Saint Catherine"],
            ["id" => "331","governorate_id" => "21","name_ar" => "أبو رديس","name_en" => "Abu Redis"],
            ["id" => "332","governorate_id" => "21","name_ar" => "أبو زنيمة","name_en" => "Abu Zenaima"],
            ["id" => "333","governorate_id" => "21","name_ar" => "رأس سدر","name_en" => "Ras Sidr"],
            ["id" => "334","governorate_id" => "22","name_ar" => "كفر الشيخ","name_en" => "Kafr El Sheikh"],
            ["id" => "335","governorate_id" => "22","name_ar" => "وسط البلد كفر الشيخ","name_en" => "Kafr El Sheikh Downtown"],
            ...
            ["id" => "339","governorate_id" => "22","name_ar" => "برج البرلس","name_en" => "Burg Al Burullus"],
            ["id" => "340","governorate_id" => "22","name_ar" => "بلطيم","name_en" => "Baltim"],
            ["id" => "341","governorate_id" => "22","name_ar" => "مصيف بلطيم","name_en" => "Masief Baltim"],
            ...
            ["id" => "345","governorate_id" => "22","name_ar" => "سيدي سالم","name_en" => "Sidi Salm"],
            ["id" => "346","governorate_id" => "22","name_ar" => "قلين","name_en" => "Qellen"],
            ["id" => "347","governorate_id" => "22","name_ar" => "سيدي غازي","name_en" => "Sidi Ghazi"],
            ["id" => "348","governorate_id" => "23","name_ar" => "مرسى مطروح","name_en" => "Marsa Matrouh"],
            ...
            ["id" => "353","governorate_id" => "23","name_ar" => "سيدي براني","name_en" => "Sidi Brani"],
            ...
            ["id" => "357","governorate_id" => "23","name_ar" => "الساحل الشمالى","name_en" => "North Coast"],
            ["id" => "358","governorate_id" => "24","name_ar" => "الأقصر","name_en" => "Luxor"],
            ["id" => "359","governorate_id" => "24","name_ar" => "الأقصر الجديدة","name_en" => "New Luxor"],
            ["id" => "360","governorate_id" => "24","name_ar" => "إسنا","name_en" => "Esna"],
            ["id" => "361","governorate_id" => "24","name_ar" => "طيبة الجديدة","name_en" => "New Tiba"],
            ["id" => "362","governorate_id" => "24","name_ar" => "الزينية","name_en" => "Al ziynia"],
            ["id" => "363","governorate_id" => "24","name_ar" => "البياضية","name_en" => "Al Bayadieh"],
            ...
            ["id" => "368","governorate_id" => "25","name_ar" => "قنا الجديدة","name_en" => "New Qena"],
            ["id" => "369","governorate_id" => "25","name_ar" => "ابو طشت","name_en" => "Abu Tesht"],
            ["id" => "370","governorate_id" => "25","name_ar" => "نجع حمادي","name_en" => "Nag Hammadi"],
            ...
            ["id" => "378","governorate_id" => "26","name_ar" => "الشيخ زويد","name_en" => "Sheikh Zowaid"],
            ["id" => "379","governorate_id" => "26","name_ar" => "نخل","name_en" => "Nakhl"],
            ["id" => "380","governorate_id" => "26","name_ar" => "رفح","name_en" => "Rafah"],
            ["id" => "381","governorate_id" => "26","name_ar" => "بئر العبد","name_en" => "Bir al-Abed"],
            ["id" => "382","governorate_id" => "26","name_ar" => "الحسنة","name_en" => "Al Hasana"],
            ["id" => "383","governorate_id" => "27","name_ar" => "سوهاج","name_en" => "Sohag"],
            ["id" => "384","governorate_id" => "27","name_ar" => "سوهاج الجديدة","name_en" => "Sohag El Gedida"],
            ["id" => "385","governorate_id" => "27","name_ar" => "أخميم","name_en" => "Akhmeem"],
            ["id" => "386","governorate_id" => "27","name_ar" => "أخميم الجديدة","name_en" => "Akhmim El Gedida"],
            ["id" => "387","governorate_id" => "27","name_ar" => "البلينا","name_en" => "Albalina"],
            ["id" => "388","governorate_id" => "27","name_ar" => "المراغة","name_en" => "El Maragha"],
            ["id" => "389","governorate_id" => "27","name_ar" => "المنشأة","name_en" => "almunsha'a"],
            ["id" => "390","governorate_id" => "27","name_ar" => "دار السلام","name_en" => "Dar AISalaam"],
            ["id" => "391","governorate_id" => "27","name_ar" => "جرجا","name_en" => "Gerga"],
            ["id" => "392","governorate_id" => "27","name_ar" => "جهينة الغربية","name_en" => "Jahina Al Gharbia"],
