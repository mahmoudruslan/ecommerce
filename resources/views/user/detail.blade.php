                ...
                <div class="col-lg-6">
                    ...
                    <div class="row align-items-stretch mb-4">
                        ...
                        <div class="col-sm-3 pl-sm-0"><a
                                ...
                                href="{{route('user.cart')}}">Add to cart</a></div>
                    </div><a class="text-dark p-0 mb-4 d-inline-block" href="#!"><i class="far fa-heart me-2"></i>Add to
                        wish list</a><br>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0"><img class="rounded-circle" src="{{asset('frontend/img/customer-1.png')}}" alt=""
                                            width="50" /></div>
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0"><img class="rounded-circle" src="{{asset('frontend/img/customer-2.png')}}"
                                            alt="" width="50" /></div>
                                    <div class="ms-3 flex-shrink-1">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product text-center skel-loader">
                        <div class="d-block mb-3 position-relative"><a class="d-block" href="{{route('user.detail')}}"><img
