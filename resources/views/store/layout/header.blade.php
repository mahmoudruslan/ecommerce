        ...
        <div class="container px-lg-3 m-auto">
            <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <!-- Link--><a class="nav-link active" href="{{ route('customer.store') }}">{{ __('Home') }}</a>
                        </li>
                        <li class="nav-item">
                            <!-- Link--><a class="nav-link" href="{{ route('customer.shopping') }}">{{ __('Shop') }}</a>
                        </li>
                        {{-- <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                <a style="display : inline-block;" class="nav-link" id="pagesDropdown" href="#"
                                    ...
                                    <img style="width : 30px;height : 30px;border-radius : 50%"
                                        src="{{ asset('storage/' . auth()->user()->image) }}" class="me-1 text-gray fw-normal">
                                </a>
                                <div class="dropdown-menu mt-3 shadow-sm" aria-labelledby="pagesDropdown">
                                    <a class="dropdown-item border-0 transition-link"
