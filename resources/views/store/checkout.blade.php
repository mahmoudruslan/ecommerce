            ...
            <div class="col-md-8">
                <div class="row gy-1">
                    ...
                    @else
                        <div class="row">
                            <div class="col-lg-12">
                                <label style="float: right" for="email"><h2 class="h5 text-uppercase">{{ __('Contact') }}</h2></label>
                                {{-- <label style="float: left" for="login">{{__("Login")}}</label> --}}
                                <a href="{{route('login')}}" style="float: left;text-decoration: underline;">{{__("Login")}}</a>
                            </div>
                            <div class="col-lg-12">

                                <input class="form-control" id="email" type="email" name="email" placeholder="{{ __('Email') }}">
                    ...
                    <div id="accordion">
                            ...
                            <div class="card-head">
                                <div class="row">
                                    <div class="col-md-1 d-flex">
                                        <input onclick="openCollapse()" name="payment" value="pay"
                        ...
                        <div style="border-radius: 0px 0px 0.25rem 0.25rem;border-color: black" class="card">
                            <div class="card-head card-background" id="cash-on-delivery">
                                <div class="row">
                                    <div class="col-md-1 d-flex">
                                        <input checked onclick="closeCollapse()" name="payment" value="on-delivery"
                                            class="form-check-input" type="radio">
                                    </div>
                                    <div class="col-md-11">
                    ...
                    <div>
                        <span onclick="completeOrder()" class="btn btn-dark mt-4">{{ __('Complete order') }}</span>
                    </div>
                </div>
            </div>
            <!-- ORDER SUMMARY-->
