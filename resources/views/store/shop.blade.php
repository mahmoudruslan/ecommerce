        ...
        <div class="container p-0">
            <div class="row">
                ...
                <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-lg-6">
                            <ul class="list-inline d-flex align-items-center justify-content-lg-end mb-0">
                                <li class="list-inline-item text-muted me-3"><a id="tow-block" class="reset-anchor p-0"
                                        href="javascript:void(0)"><i class="fas fa-th-large"></i></a></li>
                                <li class="list-inline-item text-muted me-3"><a id="three-block" class="reset-anchor p-0"
                    ...
                    <x-store.view-products :products="$products" class="col-4"></x-view-products>
                    <!-- PAGINATION-->
