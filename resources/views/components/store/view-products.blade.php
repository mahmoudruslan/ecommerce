                ...
                <div class="mb-3 position-relative">
                    ...
                    <div class="product-options-btn">
                        <div class="wishlist-icon">
                            ...
                            <a onclick="addToWishList({{ $product->id }}, 'http\://{{ request()->httpHost() }}/add-to-wishlist')"
                                ...
                                <i class="{{ \Cart::session('wishList')->getContent()->pluck('id')->contains($product->id)? 'bold': '' }} far fa-heart heart">
                                </i>
                            </a>
                        </form>
                        </div>
                        <div class="modal-icon">
                            <a class="w-100 btn btn-sm" href="#productView{{ $product->slug }}"
                    ...
                    <div class="product-overlay">
                        <ul class="mb-0 list-inline">
                            ...
                            <li class="list-inline-item m-0 p-0">
                                <form action="">
                                    <a class="btn btn-sm btn-dark" {{-- status = quantity status --}}
