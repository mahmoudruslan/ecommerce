        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @canany(['categories', 'store-categories', 'update-categories', 'show-categories', 'delete-categories'])
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseCategory" class="collapse @if ($route == 'categories') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">{{ __('Categories Screens:') }} </h6>
                            @can(['store-categories'])
                                <a class="collapse-item"
                                    href="{{ route('admin.categories.create') }}">{{ __('Add Categories') }}</a>
                            @endcan
                            <a class="collapse-item"
            ...
            @canany(['tags', 'store-tags', 'update-tags', 'show-tags', 'delete-tags'])
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTag" class="collapse @if ($route == 'tags') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @canany(['products', 'store-products', 'update-products', 'show-products', 'delete-products'])
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseProducts" class="collapse @if ($route == 'products') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">{{ __('Categories Screens:') }} </h6>
                            @can(['store-products'])
         ...
         @endcanany
            ...
            @canany(['roles', 'store-roles', 'update-roles', 'show-roles', 'delete-roles'])
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseSettings" class="collapse @if ($route == 'permission-role') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">{{ __('Roles and permissions Screens:') }} </h6>
                            @can('store-roles')
                                <a class="collapse-item"
                                    href="{{ route('admin.permission-roles.create') }}">{{ __('Add roles and permissions') }}</a>
                            @endcan
                            <a class="collapse-item"
                                href="{{ route('admin.permission-roles.index') }}">{{ __('Roles and permissions') }}</a>
                        </div>
                    </div>
                </li>
            @endcanany
            ...
            @canany(['users', 'store-users', 'update-users', 'show-users', 'delete-users'])
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUsers" class="collapse @if ($route == 'users') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @endcanany
            {{-- supervisors --}}
            @canany(['supervisors', 'store-supervisors', 'update-supervisors', 'show-supervisors',
                'delete-supervisors'])
                <!-- Nav Item - Pages Collapse Menu -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapseSupervisors" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fas fa-user-cog"></i>
                        <span>{{ __('Supervisors') }}</span>
                    </a>
                    <div id="collapseSupervisors" class="collapse @if ($route == 'supervisors') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">{{ __('Supervisors Screens:') }} </h6>
                            @can('store-supervisors')
                                <a class="collapse-item"
                                    href="{{ route('admin.supervisors.create') }}">{{ __('Add Supervisors') }}</a>
                            @endcan
                            <a class="collapse-item"
                                href="{{ route('admin.supervisors.index') }}">{{ __('Supervisors') }}</a>
                        </div>
                    </div>
                </li>
            @endcanany
            ...
            @canany(['coupons', 'store-coupons', 'update-coupons', 'show-coupons', 'delete-coupons'])
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseCoupons" class="collapse @if ($route == 'coupons') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @endcanany
            {{-- governorates --}}
            @canany(['governorates', 'store-governorates', 'update-governorates', 'show-governorates',
                'delete-governorates'])
                <!-- Nav Item - Pages Collapse Menu -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapseGovernorates" aria-expanded="true" aria-controls="collapsePages">
                        {{-- <i class="fa fa-map-marker"></i> --}}
                        <i class="fa fa-map-marker-alt"></i>
                        <span>{{ __('Governorates') }}</span>
                    </a>
                    <div id="collapseGovernorates" class="collapse @if ($route == 'governorates') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @canany(['cities', 'store-cities', 'update-cities', 'show-cities', 'delete-cities'])
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseCities" class="collapse @if ($route == 'cities') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @canany(['reviews', 'store-reviews', 'update-reviews', 'show-reviews', 'delete-reviews'])
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseReviews" class="collapse @if ($route == 'reviews') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            @endcanany
            {{-- user addresses --}}
            @canany(['user-addresses', 'show-user-addresses', 'delete-user-addresses', 'update-user-addresses',
                'store-user-addresses'])
                <!-- Nav Item - Pages Collapse Menu -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapseUserAddresses" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fa fa-home" aria-hidden="true"></i>
                        <span>{{ __('Users addresses') }}</span>
                    </a>
                    <div id="collapseUserAddresses" class="collapse @if ($route == 'user-addresses') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">{{ __('Users addresses screens:') }} </h6>
                            <a class="collapse-item"
                                href="{{ route('admin.user-addresses.index') }}">{{ __('Users addresses') }}</a>
                        </div>
                    </div>
                </li>
            @endcanany
            {{-- shipping companies --}}
            @canany(['shipping-companies', 'show-shipping-companies', 'delete-shipping-companies',
                'update-shipping-companies', 'store-shipping-companies'])
                <!-- Nav Item - Pages Collapse Menu -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapseShippingCompanies" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fas fa-shipping-fast"></i>
                        <span>{{ __('Shipping companies') }}</span>
                    </a>
                    <div id="collapseShippingCompanies" class="collapse @if ($route == 'shipping-companies') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">{{ __('Shipping companies screens:') }} </h6>
                            <a class="collapse-item"
                                href="{{ route('admin.shipping-companies.index') }}">{{ __('Shipping companies') }}</a>
                            <a class="collapse-item"
                                href="{{ route('admin.shipping-companies.create') }}">{{ __('Add shipping companies') }}</a>
                        </div>
                    </div>
                </li>
            @endcanany
            {{-- payment-methods --}}
            @canany(['payment-methods', 'show-payment-methods', 'delete-payment-methods', 'update-payment-methods',
                'store-payment-methods'])
                <!-- Nav Item - Pages Collapse Menu -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapsePaymentMethods" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fas fa-shipping-fast"></i>
                        <span>{{ __('Payment methods') }}</span>
                    </a>
                    <div id="collapsePaymentMethods" class="collapse @if ($route == 'admin.payment-methods') show @endif"
                        aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">{{ __('Payment methods screens:') }} </h6>
                            <a class="collapse-item"
                                href="{{ route('admin.payment-methods.index') }}">{{ __('Payment methods') }}</a>
                            <a class="collapse-item"
                                href="{{ route('admin.payment-methods.create') }}">{{ __('Add payment methods') }}</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseProductSetting" class="collapse @if ($route == 'product-setting') show @endif"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item"
                               href="{{ route('admin.attribute-values.index') }}">{{ __('Options') }}</a>
                        </div>
                    </div>
                </li>
            @endcanany
