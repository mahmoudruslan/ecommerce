                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form action="{{route('admin.permission-role.store')}}" method="POST" class="user">
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            @foreach ($permissions as $permission)
                                                ...
                                                <div style="display: inline-block" class="custom-control custom-checkbox small">
                                                    <input name="permissions[]" type="checkbox" class="custom-control-input" value="{{$permission->name}}" id="customCheck{{$loop->index}}">
