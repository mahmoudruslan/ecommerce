    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">{{ __('Edit user address') }}</h1>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">{{ __('Edit address to') }} : {{$user_address->user->fullName}}</h1>
                                            </div>
                                            <form action="{{ route('admin.user-addresses.store') }}" method="POST"
                                                class="user">
                                                @csrf
                                                <input type="hidden" name="user_id" value="{{$user_address->user->id}}">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="email" value="{{ $user_address->email }}" 
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <input type="text" name="mobile" value="{{ $user_address->mobile }}" 
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="po_box" value="{{ $user_address->po_box }}" 
                                                ...
                                                {{-- <div class="form-group row">
                                                    <div class="col-md-6">
                                                        ...
                                                        @error('governorate_id') is-invalid @enderror">
                                                            <option value="{{ $user_address->governorate->id }}" selected>{{ $user_address->governorate['name_' . app()->getLocale()] }}</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        @error('city_id') is-invalid @enderror">
                                                            <option value="{{ $user_address->city->id }}" selected>{{ $user_address->city['name_' . app()->getLocale()] }}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" name="address_en" value="{{ $user_address->address_en }}" 
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        <input type="text" name="address2_ar" value="{{ $user_address->address2_ar }}" 
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" name="address2_en" value="{{ $user_address->address2_en }}" 
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <input type="text" name="address_title_ar" value="{{ $user_address->address_title_ar }}" 
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="address_title_en" value="{{ $user_address->address_title_en }}" 
